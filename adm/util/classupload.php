<?php 
	class UploadImagem{ 
		...
		protected function redimensionar($caminho, $nomearquivo){ 
			...
			} // -> fim if // Criando a imagem com o novo tamanho 
			$novaimagem = imagecreatetruecolor($width, $height); 
			switch($tipo){ 
// 				// Se o tipo da imagem for gif 
// 				case 1: // Obtém a imagem gif original 
...
// 					break; 
				...
				case 2: // Obtém a imagem jpg original 
				...
				case 3: // Obtém a imagem png original 
					...
					break; 
			} // -> fim switch // Destrói a imagem nova criada e já salva no lugar da original 
